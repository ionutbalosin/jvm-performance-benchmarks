...
Even though, an interesting case is why OpenJDK VM runs faster than GraalVM EE/CE the `initial_loops` benchmark.
...
OpenJDK VM hottest methods report:
...
2   | OpenJDK VM       | x86_64      | 4,638,065.96   | ns/op
...
2   | OpenJDK VM       | arm64       | 2,614,295.98   | ns/op
