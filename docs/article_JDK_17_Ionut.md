...
0x00007fffe0ef17a0:   cmp    $0x3e2,%r10d       ;compare against 994
...
```
0x00007fffdef45310:   cmp    $0x3e8,%r10d       ;compare against 1000 (i.e., the loop limit)
0x00007fffdef45317:   jge    0x00007fffdef4534c ;*if_icmpge
...
0x00007fffdef4532d:   lea    0x2(%r10),%r10d    ;*iinc by loop stride
...
