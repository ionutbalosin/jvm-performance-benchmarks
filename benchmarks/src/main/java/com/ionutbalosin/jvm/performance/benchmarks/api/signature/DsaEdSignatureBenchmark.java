...
/*
 * This benchmark measures the performance of EDDSA (Edwards curve DSA) using different message lengths,
 * key lengths.
 */
...
public class DsaEdSignatureBenchmark {
  ...
  public void setup() throws Exception {
    ...
    KeyPairGenerator kpg = KeyPairGenerator.getInstance(algorithm, "SunEC");
